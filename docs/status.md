# Bridge365: Project Status

Status summary and full version-by-version history for the Bridge365 project. See [README.md](../README.md) for the project overview, quick start, and architecture.
