...
- `docs/status.md` (new file): contains the full Status Summary table and Detailed Status (IMPLEMENTED/ROADMAP/BACKLOG) history, preserved verbatim from `README.md`, including the v0.5.3 entry below.
